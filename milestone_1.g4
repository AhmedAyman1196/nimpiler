...
INDENTATION : [\t]; // NOT ADDED IN py FILE OR start
...
GENERALIZED_STR_LIT: IDENTIFIER'('RSTR_LIT')' ;
GENERALIZED_TRIPLESTR_LIT: IDENTIFIER'('TRIPLESTR_ITEM')' ;
...
| TRIPLESTR_LIT |STR_LIT | CHAR_LIT  |TRIPLESTR_ITEM | RSTR_LIT |GENERALIZED_STR_LIT | GENERALIZED_TRIPLESTR_LIT

| IDENTIFIER | LETTER | COMMA | DIGIT
